...
export default function AdBanner({ slot = 'default', format = 'horizontal' }) {
  ...
  return (
    <div className="ad-container" style={{ minHeight: format === 'horizontal' ? '100px' : '270px' }}>
...
<ins class="adsbygoogle"
   ref={ref}
     ...
     data-full-width-responsive="true"/>
      ...
      <div className="ad-mock" style={{ position: 'absolute', pointerEvents: 'none' }}>
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" style={{ marginBottom: 6, opacity: 0.4 }}>
          <rect x="2" y="6" width="20" height="12" rx="2" stroke="currentColor" strokeWidth="1.5" />
          <path d="M7 12h10M7 15h6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
        <div>Google AdSense – {format} ad</div>
        <div style={{ fontSize: '0.75rem', marginTop: 2 }}>Add your Publisher ID to activate</div>
      </div>
    </div>
  )
}
